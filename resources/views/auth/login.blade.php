    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
            ...
            <input name="email" class="form-control py-4 @error('email') is-invalid @enderror" id="input_login_email"
                name="email" value="{{ old('email') }}" type="email" placeholder="Enter email address"
                autocomplete="email" />
        ...
        <div class="form-group">
            ...
            <input name="password" class="form-control py-4 @error('email') is-invalid @enderror" id="input_login_password"
